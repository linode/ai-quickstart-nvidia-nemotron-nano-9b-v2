...
#   bash <(curl -fsSL https://raw.githubusercontent.com/linode/ai-quickstart-nvidia-nemotron-nano-9b-v2/main/deploy.sh)
#
#==============================================================================
...
print_msg "$CYAN" "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
print_msg "$YELLOW" "Deploys a GPU instance with vLLM, Open-WebUI, and Nemotron-Nano-9B-v2 model (~10-15 min)"
echo ""
...
print_msg "$YELLOW" "Waiting for vLLM to download NVIDIA-Nemotron-Nano-9B-v2 model... (this may take 3-5 minutes)"
scroll_up 8
START_TIME=$(date +%s)
...
while true; do
    ...
    if ssh "${SSH_OPTS[@]}" "root@${INSTANCE_IP}" "curl -s http://localhost:8000/v1/models" </dev/null 2>/dev/null | grep -q '"id":"nvidia/NVIDIA-Nemotron-Nano-9B-v2"'; then
...
echo ""
echo ""
echo "🚀 Enjoy your AI Quickstart NVIDIA-Nemotron-Nano-9B-v2 on Akamai Cloud !!"
echo ""
echo ""
